...
class RouterExplorer {
    ...
    extractRouterPath(metatype) {
        ...
        return [shared_utils_1.addLeadingSlash(path)];
    }
        ...
        paths.forEach(path => {
            ...
            pathsToLog.forEach(path => {
                if (isVersioned) {
                    ...
                    this.logger.log(messages_1.VERSIONED_ROUTE_MAPPED_MESSAGE(path, requestMethod, version));
                }
                else {
        ...
        return (req, res, next) => {
            ...
            if (versioningOptions.type === version_type_enum_1.VersioningType.CUSTOM) {
                ...
                if (Array.isArray(version)) {
                    ...
                    else if (shared_utils_1.isString(extractedVersion) &&
