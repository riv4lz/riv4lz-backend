...
class Injector {
    ...
    async resolveConstructorParams(wrapper, moduleRef, inject, callback, contextId = constants_2.STATIC_CONTEXT, inquirer, parentInquirer) {
        ...
        const isFactoryProvider = !shared_utils_1.isNil(inject);
    ...
    getFactoryProviderDependencies(wrapper) {
        ...
        const isOptionalFactoryDep = (item) => !shared_utils_1.isUndefined(item.token) &&
            !shared_utils_1.isUndefined(item.optional);
